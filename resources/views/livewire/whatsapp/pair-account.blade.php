...
<div @if ($shouldPoll) wire:poll.5s="refreshSnapshot" @endif>
    <section class="mx-auto flex min-h-[calc(100vh-12rem)] w-full max-w-4xl items-center px-6 py-12 lg:px-8">
        <div class="w-full overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/70 shadow-2xl shadow-slate-950/40 backdrop-blur">
            <div class="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <div class="bg-white p-8 text-slate-900 lg:p-10">
                    @if ($isSuccess)
                        <div class="flex min-h-[26rem] flex-col items-center justify-center rounded-[1.75rem] border border-emerald-200 bg-emerald-50 px-6 text-center">
                    ...
                    @elseif ($isInvalid)
                        <div class="flex min-h-[26rem] flex-col items-center justify-center rounded-[1.75rem] border border-rose-200 bg-rose-50 px-6 text-center">
                    ...
                    @elseif ($isQrReady)
                        <div class="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                            <div class="mx-auto flex w-full max-w-sm justify-center rounded-[1.5rem] bg-white p-5 shadow-sm shadow-slate-200/80">
                                <img src="{{ $qrSvg }}" alt="رمز ربط واتساب" class="h-auto w-full max-w-xs">
                            </div>
                    ...
                    @else
                        <div class="flex min-h-[26rem] flex-col items-center justify-center rounded-[1.75rem] border border-slate-200 bg-slate-50 px-6 text-center">
